    ...
    <div className='mainPageMainDiv'>
        <Header/>
            ...
            <div id='businessCard2'>
                <h1 className='h1BusinessCard' style={{fontSize:'23px'}}>? בעל עסק </h1>
                <h1 className='h1BusinessCard' style={{fontSize:'23px'}}>? רואה חשבון</h1>
                <h1 className='h1BusinessCard' style={{fontSize:'23px'}}>? עורך דין </h1>
                <h1 className='h1BusinessCard' style={{fontSize:'23px'}}>? יש לך חנות באינטרנט </h1>
                <h1 className='h1BusinessCard' style={{fontSize:'23px',borderTop:'5px solid white',borderTopRightRadius:'10%',borderTopLeftRadius:'10%',borderBottom:'5px solid white',borderBottomRightRadius:'10%',borderBottomLeftRadius:'10%',width:'100%',marginTop:'5%'}}>בוא נגיד לך איך מתחילים לקדם את העסק שלך עם כרטיס הביקור הדיגיטלי</h1>
            ...
            <h3 style={{fontSize:'15px', alignSelf:'flex-end'}} className='h3HomeMainTitle'> קישור לאתר שלך✅</h3>
            <h3 style={{fontSize:'15px', alignSelf:'flex-end'}} className='h3HomeMainTitle'>של העסק Waze קישור חכם ל✅</h3>
            <h3 style={{fontSize:'15px', alignSelf:'flex-end'}} className='h3HomeMainTitle'>  (לידים) טופס יצירת קשר✅</h3>
            </div>
